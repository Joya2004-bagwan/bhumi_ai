...
async def upload_image(file: UploadFile = File(...)):
    ...
    try:
        ...
        log_event("upload", image_id=image_id, filename=original_filename,
                  width=width, height=height, size_bytes=file_size)
...
async def segment_image(request: SegmentRequest):
    ...
    try:
        ...
        log_event("segment", image_id=request.image_id, model=request.model,
